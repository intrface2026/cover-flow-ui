          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-border/40 bg-card overflow-hidden">
              ...
              <div className="p-4 bg-black/5 dark:bg-white/5 font-mono text-sm text-foreground overflow-x-auto">
                <span className="text-blue-500">pnpm</span> dlx <span className="text-teal-500">shadcn@latest</span> add <span className="text-muted-foreground">https://intrface.in/registry/cover-flow.json</span>
              </div>
            </div>
