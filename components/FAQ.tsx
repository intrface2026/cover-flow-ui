      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="border-y border-dashed border-border/70 divide-y divide-dashed divide-border/70">
          ...
          <details className="faq-item group">
            ...
            <p className="pb-5 pr-8 text-[15px] leading-relaxed text-muted-foreground">
              Install the Cover Flow component with the shadcn CLI — npx shadcn add https://intrface2026.github.io/cover-flow-ui/registry/cover-flow.json — or from npm as @intrface2026/cover-flow-ui. Then render the CoverFlow component with your items. It works in any modern React or Next.js App Router project.
            </p>
          </details>
